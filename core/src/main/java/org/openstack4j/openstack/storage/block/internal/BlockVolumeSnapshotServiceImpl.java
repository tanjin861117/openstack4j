...
public class BlockVolumeSnapshotServiceImpl extends BaseBlockStorageServices implements BlockVolumeSnapshotService {
    ...
    public List<? extends VolumeSnapshot> list(Map<String, String> filteringParams) {
        Invocation<VolumeSnapshots> volumeInvocation = buildInvocation("/snapshots", filteringParams);
        return volumeInvocation.execute().getList();
    }

    public List<? extends VolumeSnapshot> list(String tag, Map<String, String> filteringParams) {
        Invocation<VolumeSnapshots> volumeInvocation = buildInvocation(uri("/snapshots?snapshot_tag=%s", tag), filteringParams);
        return volumeInvocation.execute().getList();
    }
    ...
    private Invocation<VolumeSnapshots> buildInvocation(String uri, Map<String, String> filteringParams) {
        Invocation<VolumeSnapshots> volumeInvocation = get(VolumeSnapshots.class, uri);
