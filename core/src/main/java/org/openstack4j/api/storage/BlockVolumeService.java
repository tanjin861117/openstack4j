...
public interface BlockVolumeService extends RestService {
    ...
    List<? extends Volume> list(String tag, Map<String, String> filteringParams);
    ...
    ActionResponse update(String volumeId, String name, String description, boolean bootable);
