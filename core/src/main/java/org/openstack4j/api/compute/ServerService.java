...
public interface ServerService {
    ...
    /**
     * Creates the image for a Server (add by jianghao)
     *
     * @param serverId     the server id
     * @param imageName the image name
     * @return the newly created image UUID
     */
    String createImage(String serverId, String imageName, Map<String, String> metadata);
    ...
    List<? extends VolumeAttachment> listVolumes(String serverId);
