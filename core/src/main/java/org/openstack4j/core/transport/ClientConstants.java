...
public final class ClientConstants {
    ...
    public static final String PATH_PROJECTS = "/v3/projects";
    public static final String PATH_ROLES = "/v3/roles";
    public static final String PATH_USERS = "/v3/users";
    public static final String PATH_SERVICES = "/services";
    public static final String PATH_DOMAINS = "/v3/domains";
